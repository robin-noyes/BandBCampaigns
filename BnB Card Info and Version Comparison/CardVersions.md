...
Begining in Core Deck version 3, tool links are no longer included and refer you to https://www.blackhillsinfosec.com/tools/backdoorsandbreaches/coredeck/v3/
...
**C2 and Exfil**\
Version 3 changes _Gmail, Tumblr, SaleseForce, Twitter/X as exfil_ to _Cloud-Based Services as Exfil_ which could encompass Saas (Zoom, Slack, Google, etc), Iaas (AWS, Google, Azure, Akami, IBM Cloud, etc ), File Sharing and Data storage (Dropbox, Google Drive, OneDrive, Box, etc ) .\
Version 3.1 no changes from 3.0
...
**Procedures:** One new cards\
**Injects:** Ten new cards\
**Consultants:** Introduces Consultants and adds nine new cards

#### Expansion Deck 1.2 11-2022
**Procedures:** One new cards \
**Consultants:** Three new cards 

#### Expansion Deck 2, 2.1
Does not appear to have any changes.
...
#### Bonus
**Consultants:** Ten new cards\

#### NRECAEXPANSION V1 02-2026 (online only)
**Initial Compromise:** Seven new cards\
**Pivot and Escalate:** Three new cards\
**Persistance:** Eight new cards\
**Procedure:** Two new cards\
**Injects:** Nine new cards\
**Consultants:** Two new cards